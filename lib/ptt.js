...
var write_charbychar = function (client, data, data_idx) {
	client.write(data[data_idx++],function(){
		if (data_idx < data.length) {
			write_charbychar(client, data, data_idx);
		} else {
			client.write('\r');
		}
	});
	...
	login: function (user, pass) {
		...
		client.on('data', function(data){
			...
			switch (client_status) {
				...
				case 3:
					client_status = 4;
					write_charbychar (client, pass, pass_idx);
					break;
				default:
					break;
			}
